...
/*   Updated: 2025/03/17 16:55:00 by vbui             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int validate_textures_and_colors(t_data *data, t_texinfo *textures)
{
    ...
    data->texinfo.hex_floor = rgb_to_hex(textures->floor[0], textures->floor[1], textures->floor[2]);
    data->texinfo.hex_ceiling = rgb_to_hex(textures->ceiling[0], textures->ceiling[1], textures->ceiling[2]);
